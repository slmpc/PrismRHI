...
final class GlDsaRawStateBridge implements RhiGlStateBridge {
    static final GlDsaRawStateBridge INSTANCE = new GlDsaRawStateBridge();

    private GlDsaRawStateBridge() {
    }
